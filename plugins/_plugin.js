...
var LANG = {
            ...
            harmful: Config.LANG == 'TR' || Config.LANG == 'AZ' ? '*Patron Bu Benim İçin Çok Tehlikeli Yükleyemem!*' : '*This Plugin Cannot Be Installed As It Is Harmful!*',
            duplicate: Config.LANG == 'TR' || Config.LANG == 'AZ' ? '*Patron Bu Pluginden Zaten Var!*' : '*You Cannot Install the Same Plugin 2 Times!*',
            limit: Config.LANG == 'TR' || Config.LANG == 'AZ' ? '*Patron Bu Plugin Güvenlik Sınırını Aşıyor!*\n*Zararlılık Yüzdesi:* _%' : '*This Plugin Exceeds Security Limit!*\n*Percentage of Harm:* _%',
